...
We used a GPU K20 and computed the solution up to 80 non-dimensional time-units (`400k` time-steps with time-increment `0.0002`) in approximatively 14 hours.