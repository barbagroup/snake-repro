...
h=0.006 in the uniform region, a time-increment of 0.0002, an absolute tolerance
of 1.0E-16 for the velocity solver, and an absolute tolerance of 1.0E-08 for the
Poisson solver.
We compare the force coefficients with those reported in the manuscript for 
h=0.004, a time-increment of 4.0E-04, and relative tolerance of 1.0E-05 as exit
criterion for the velocity and Poisson solvers.

This script generates the figure `forceCoefficientsCompareTol.png` saved in the
same directory.
"""
...
# with grid-spacing h=0.006 in the uniform region and rtol=1.0E-06.
...
simulation = CuIBMSimulation(description='h=0.006',
                             directory=simulation_directory)
simulation.read_forces()
simulation.get_mean_forces(limits=[32.0, 64.0])

# Computes the mean force coefficients from the cuIBM simulation
# with grid-spacing h=0.004 in the uniform region and rtol=1.0E-05.
# The force coefficients are averaged between 32 and 64 time-units.
simulation_directory = os.path.join(os.path.dirname(__file__), 
                                    'h0.004')
simulation2 = CuIBMSimulation(description='h=0.004',
                              directory=simulation_directory)
