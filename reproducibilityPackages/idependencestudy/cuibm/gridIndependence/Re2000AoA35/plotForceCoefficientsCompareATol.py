...
This script generates the figure `forceCoefficientsCompareATol.png` saved in the
same directory.
"""
...
# Computes the mean force coefficients from the cuIBM simulation
# with grid-spacing h=0.006 in the uniform region and atol=1.0E-05 for the 
# Poisson solver.
# The force coefficients are averaged between 32 and 64 time-units.
simulation_directory = os.path.join(os.path.dirname(__file__), 
                                    'h0.006_vatol16_patol5_dt0.0002')
simulation2 = CuIBMSimulation(description='atol=1.0E-05',
                              directory=simulation_directory)
