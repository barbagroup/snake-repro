# file: plotForceCoefficientsRe2000AoA35Revision77Cusp040.py
...
simulation = CuIBMSimulation(description='cuIBM - cusp-0.4.0',
                             directory=os.path.join(os.environ['HOME'],
                                                    'simulations_cuIBM',
                                                    'flyingSnake2d',
                                                    'revision77_cusp-0.4.0',
                                                    'flyingSnake2dRe2000AoA35_20150924',
                                                    'numericalSolution'))
...
pyplot.savefig('cuibm-revision77-cusp-0.4.0_forceCoefficientsRe2000AoA35.pdf',
               bbox_inches='tight',
               format='pdf')