...
simulation = CuIBMSimulation(description='cuIBM (current) - cusp-0.5.1',
                             directory=os.path.join(os.environ['HOME'],
                                                    ...
                                                    'flyingSnake2dRe2000AoA30_20160502'))
...
pyplot.savefig('cuibm-cusp-0.5.1_forceCoefficientsRe2000AoA30.pdf',
               bbox_inches='tight',
               format='pdf')
pyplot.savefig('cuibm-cusp-0.5.1_forceCoefficientsRe2000AoA30.png',
               bbox_inches='tight',
               format='png')
