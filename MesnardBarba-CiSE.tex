...
\section*{Fluid-flow solvers we used}
...
\href{https://github.com/ibamr/ibamr}  
\textbf{PetIBM}--- Our own re-implementation of \textbf{cuIBM}, but for distributed-memory parallel systems.
...
\begin{figure*}
\centering
%\includegraphics[width=0.8\textwidth]{./figures/openfoam/openfoam_vorticity52Re2000AoA35_gmshZeroGradient.pdf}
\caption{
...
\begin{figure*}
\centering
%\includegraphics[width=0.8\textwidth]{./figures/openfoam/openfoam_pressure52Re2000AoA35_gmshZeroGradient.pdf}
%\includegraphics[width=0.8\textwidth]{./figures/openfoam/openfoam_pressure53Re2000AoA35_gmshZeroGradient.pdf}
\caption{
...
\begin{figure*}
\centering
%\includegraphics[width=0.8\textwidth]{./figures/openfoam/openfoam_forceCoefficientsVsAoA.pdf}
\caption{
...
\begin{figure*}
\centering
%\includegraphics[width=0.8\textwidth]{./figures/openfoam/openfoam_forceCoefficientsRe2000AoA30.pdf}
%\includegraphics[width=0.8\textwidth]{./figures/openfoam/openfoam_forceCoefficientsRe2000AoA35.pdf}
\caption{
...
\section*{Story 4: Different versions of your code, the external libraries or even compilers may challenge reproducibility}
...
--
 ...
 \section*{Definition of reproducible research}
