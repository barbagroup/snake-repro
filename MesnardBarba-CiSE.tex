...
\begin{figure*}
\centering
\includegraphics[width=0.8\textwidth]{./figures/openfoam/openfoam_pressure52Re2000AoA35_gmshZeroGradient.png} % << not available in pdf ?
\includegraphics[width=0.8\textwidth]{./figures/openfoam/openfoam_pressure53Re2000AoA35_gmshZeroGradient.png} % << not available in pdf ?
\caption{
