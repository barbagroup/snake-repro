...
Figure 1: 
Filled contour of the vorticity field after 52 time-units of flow simulation with IcoFOAM for a snake section with angle-of-attack 35° and Reynolds number 2000.
...
Figure 2:
Filled contour of the pressure field after 52 (top) and 53 (bottom) time-units of flow simulation with IcoFOAM for snake section with angle-of-attack 35° and Reynolds number 2000.

![Figure 3](./figures/openfoam/openfoam_forceCoefficientsVsAoA.png)

Figure 3:
Time-average drag (top) lift (bottom) coefficients as function of the snake's angle-of-attack for Reynolds numbers 1000 and 2000.
We average all IcoFOAM force coefficients between 32 and 64 time-units of flow simulation and compare with cuIBM results from our previous study.
...
Figure 4:
Instantaneous force coefficients generated by a snake section with angle-of-attack 30° (top) and 35° (bottom) at Reynolds number 2000.
...
Figure 5:
Filled contour of the vorticity field after about 61 time-units of flow simulation with IBAMR for a snake section with angle-of-attack 35° and Reynolds number 2000.
...
Figure 6:
Time-averaged drag (top) and lift (bottom) coefficients as function of the angle-of-attack of the snake section for Reynolds numbers 1000 and 2000.
We averaged each force signal between 32 and 64 time-units of flow simulation with IBAMR.
We compare with results from our previous investigation.
...
We compare IBAMR results with cuIBM ones from our past study.
...
We show results obtained when the immersed-boundary is rotated around: (1) its center of mass (green and orange symbols) and (2) the reference origin (0,0).
...
Figure 9: 
Instantaneous force coefficients for the snake section with angle-of-attack 35° and Reynolds number 2000.
The figure on the top compares the PetIBM results with those reported in our previous study.
The figure on the bottom compares results with the immersed-boundary is rotated around its center of mass (slightly shifted than in our previous study) and around the origin of the frame (identical set of markers than in our previous study).
...
Figure 10:
Filled contour of the vorticity field after 19, 52, 53, and 64 time-units of flow simulation with PetIBM for a snake section at angle-of-attack 35° and Reynolds number 2000.
...
Figure 11:
Instantaneous force coefficients generated on the snake section at (a) Reynolds number 1000 and angle 35° and (b) Reynolds number 2000 and angle 30°.
