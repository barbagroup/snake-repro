...
Barba made a public pledge titled *"Reproducibility PI Manifesto"*\cite{0ccc9e7d-7d3d-4eee-a836-8169881695c8} (PI: Principal Investigator), which at the core is a promise to make all research materials and methods open access and discoverable: releasing code, data and analysis/visualization scripts.
